Rails.application.routes.draw do
  ...
  get 'site_manage/manage_servers'
  ...
  get 'site_manage/expire_server_detail/:id(.:format)' => 'site_manage#expire_server_detail', as: 'expire_server_detail'
  ...
  post 'site_manage/update_server/:id(.:format)' => 'site_manage#update_server', as: 'update_server'
  ...
  get '/carts/remove_coupon'
  post '/welcome/image_upload'
  get '/items/add_plan_to_cart'
